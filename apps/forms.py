...
class FormOrderPackage(ModelForm):
    ...
    class Meta:
        model = OrderPackage
        exclude = ['order', 'total_price', 'category', 'package', 'type', 'entry_date', 'main_cuisine', 'sub_cuisine', 'side_cuisine1', 'side_cuisine2', 'side_cuisine3', 'side_cuisine4', 'side_cuisine5', 'unit_price', 'extra_price', 'rice', 'bag', 'box_type', 'upgrade',
                   'entry_by', 'update_date', 'update_by']
