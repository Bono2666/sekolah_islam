...
urlpatterns = [
    ...
    path('order/child/add/<path:_id>/',
         views.order_child_add, name='order-child-add'),
    path('order/child/update/<path:_id>/<int:_child>/',
         views.order_child_update, name='order-child-update'),
    path('order/package/add/<path:_id>/<str:_cat>/<str:_pack>/',
         views.order_package_add, name='order-package-add'),
    path('order/package/update/<path:_id>/<int:_package>/<str:_cat>/<str:_pack>/',
